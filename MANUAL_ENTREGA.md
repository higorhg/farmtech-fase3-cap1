...
Passo-a-passo final para o **Higor** rodar nas próximas 48h e submeter no portal.
...
> "Olá, sou o Higor Henrique Garcia, RM571820. Aqui no projeto da Fase 3 Cap 1
> do curso de Inteligência Artificial da FIAP, fizemos a entrega-agregadora
> com o grupo: Vinicius, Igor, Humberto e eu. O tema é a cultura de café
...
- Abrir o notebook `ml/HigorHenriqueGarcia_RM571820_fase3_cap10.ipynb`.
...
1. Logar em <https://on.fiap.com.br/mod/assign/view.php?id=605373>.
2. Clicar em **"Trazer Grupo Anterior"** na seção GRUPO (puxa Vinicius/Igor/Humberto).
